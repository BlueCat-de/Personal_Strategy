...
![可转债实时数据](../assets/bond_api-9be90fe3caae.jpg)
...
![dataframe格式的可转债](../assets/df-info-9cf3ff488b5d.jpg)

因为数据已经封装好的，所以调用很方便。接口获取可关注公众号，回复： 可转债接口

## 可转债强赎与数日子

![强赎转债最后一个月的涨跌幅](../assets/redeem-b3d852adbdcf.jpeg)

接口数据不仅可以在Ptrade里面调用，还可以做成微信推送等方式

![强赎转债最后一个月的涨跌幅](../assets/redeem_info-ab5781707dbb.png)
...
![不下修转债接口](../assets/not_change_price-a229d1d7a975.jpg)
